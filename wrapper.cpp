...
/* Getting our class and function implementations to wrap. */
#include "demo.h"

/** pybind11 macro that binds C++ code into a module so that these classes and functions can be called in a Python 
* script. 
